...
import { Instagram, Facebook, MapPin, Phone, Mail, Heart, Send, MessageCircle, Globe } from 'lucide-react'
      ...
      <div className="container-site relative py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            <div className="mb-4">
              <h3 className="font-display text-2xl font-semibold text-gold-gradient">Golden Zaf</h3>
            ...
            <ul className="space-y-3">
              ...
              <li>
                ...
                >
                  ...
                  <span>{isAmharic ? 'በ WhatsApp ይፃፉልን' : 'Chat on WhatsApp'}</span>
                </a>
              </li>
              <li>
                <a
        ...
        <div className="mt-12 pt-6 border-t border-gold-500/20 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          >
            © {new Date().getFullYear()} Golden Zaf Furniture and Interior. {t('rights')}.
          </p>
