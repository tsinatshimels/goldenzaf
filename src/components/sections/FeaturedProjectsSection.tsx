...
// Fallback demo projects for when CMS has no data
...
export function FeaturedProjectsSection({ projects }: Props) {
  ...
  const getProjectImage = (project: Project) => {
    ...
    return categoryImages[project.category]?.[0] || categoryImages.living_room[0]
  }
      ...
      <div className="container-site">
        ...
        >
          ...
          <Link
            ...
            className={cn('btn-outline group shrink-0', isAmharic && 'font-amharic')}
          >
            {t('view_all')}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {displayProjects.slice(0, 6).map((project, i) => {
            ...
            const catLabel = isAmharic
              ? categoryLabels[project.category]?.am
            ...
            return (
              <motion.article
                ...
                className={cn(
                  'group card-glass overflow-hidden',
                ...
                <Link href={`/${locale}/projects/${project.slug.current}`}>
                  ...
                  <div className="relative h-64 overflow-hidden">
                    ...
                    <div className="absolute top-4 left-4">
                      <span className={cn(
                        'text-xs px-3 py-1 bg-gold-500 text-forest-900 font-semibold tracking-wider',
                        isAmharic && 'font-amharic text-[11px]'
                      )}>
                        {catLabel}
                      </span>
                    </div>
                  ...
                  <div className="p-6">
                    <h3 className={cn(
                      'font-display text-xl font-semibold text-[var(--text-primary)] mb-2 group-hover:text-gold-500 transition-colors line-clamp-1',
                    ...
                    {desc && (
                      <p className={cn(
                        'text-sm text-[var(--text-secondary)] line-clamp-2',
